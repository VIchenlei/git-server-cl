...
const CLIENT_ROOT = path.resolve(APP_ROOT, `./gis-client`)
...
let config = {
  ...
  NeedInformCollectorList: ['setting', 'card', 'map', 'area', 'reader', 'antenna', 'path', 'drivingface', 'drivingface_render', 'dat_drivingface_warning_point', 'rules', 'vehicle_extend', 'staff_extend', 'staff_extend_ck', 'drivingface_vehicle', 'dat_handup_vehicle', 'light', 'lights_binding', 'lights_group', 'geofault', 'reader_path_tof_n', 'map_gis', 'landmark', 'work_face', 'coalface', 'coalface_vehicle', 'area_reader', 'area_persons_dynamic_thre', 'drivingface_ref_point', 'intersection_point']
}
